...
* 3D:
    ...
    * **3D-VisTA**: "3D-VisTA: Pre-trained Transformer for 3D Vision and Text Alignment", arXiv, 2023 (*Beijing Institute for General Artificial Intelligence (BIGAI)*). [[Paper](https://arxiv.org/abs/2308.04352)][[Website](https://3d-vista.github.io/)]
* Vision-Speech-Text:
