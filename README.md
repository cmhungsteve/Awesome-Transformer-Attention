...
* For general performance:
    ...
    * **Focal**: "Focal Self-attention for Local-Global Interactions in Vision Transformers", NeurIPS, 2021 (*Microsoft*). [[Paper](https://arxiv.org/abs/2107.00641)]
    ...
    * **TNT**: "Transformer in Transformer", arXiv, 2021 (*Huawei*). [[Paper](https://arxiv.org/abs/2103.00112)][[PyTorch](https://github.com/huawei-noah/CV-Backbones/tree/master/tnt_pytorch)][[PyTorch (lucidrains)](https://github.com/lucidrains/transformer-in-transformer)]
    ...
    * **LV-ViT**: "Token Labeling: Training a 85.5% Top-1 Accuracy Vision Transformer with 56M Parameters on ImageNet", arXiv, 2021 (*ByteDance*). [[Paper](https://arxiv.org/abs/2104.10858)][[PyTorch](https://github.com/zihangJiang/TokenLabeling)]
...
* Conv + Transformer:
    ...
    * **MobileViT**: "MobileViT: Light-weight, General-purpose, and Mobile-friendly Vision Transformer", arXiv, 2021 (*Apple*). [[Paper](https://arxiv.org/abs/2110.02178)]
* For pre-training:
    ...
    * **drloc**: "Efficient Training of Visual Transformers with Small-Size Datasets", NeurIPS, 2021 (*University of Trento*). [[Paper](https://arxiv.org/abs/2106.03746)]
...
* CNN-based backbone:
    ...
    * **ViDT**: "ViDT: An Efficient and Effective Fully Transformer-based Object Detector", arXiv, 2021 (*NAVER*). [[Paper](https://arxiv.org/abs/2110.03921)]
...
* **VATT**: "VATT: Transformers for Multimodal Self-Supervised Learning from Raw Video, Audio and Text", NeurIPS, 2021 (*Google*). [[Paper](https://arxiv.org/abs/2104.11178)]
...
* **SOTA**: "SOAT: A Scene- and Object-Aware Transformer for Vision-and-Language Navigation", NeurIPS, 2021 (*Georgia Tech*). [[Paper](https://arxiv.org/abs/2110.14143)]
...
* Segmentation:
    ...
    * **UNETR**: "UNETR: Transformers for 3D Medical Image Segmentation", arXiv, 2021 (*NVIDIA*). [[Paper](https://arxiv.org/abs/2103.10504)][[PyTorch](https://github.com/Project-MONAI/research-contributions/tree/master/UNETR/BTCV)]
...
* Feature Matching:
    ...
    * **CATs**: "Semantic Correspondence with Transformers", NeurIPS, 2021 (*Yonsei University + Korea University*). [[Paper](https://arxiv.org/abs/2106.02520)][[Code (in construction)](https://github.com/SunghwanHong/CATs)][[Website](https://sunghwanhong.github.io/CATs/)]
* Multi-label:
