...
* **SWFormer**: "SWFormer: Sparse Window Transformer for 3D Object Detection in Point Clouds", arXiv, 2022 (*Waymo*). [[Paper](https://arxiv.org/abs/2210.07372)]
...
* **VQGAN-CLIP**: "VQGAN-CLIP: Open Domain Image Generation and Manipulation with Natural Language Guidance", ECCV, 2022 (*EleutherAI*). [[Paper](https://arxiv.org/abs/2204.08583)][[PyTorch](https://github.com/EleutherAI/vqgan-clip)]
