...
* X-supervised:
    ...
    * **Semi-DETR**: "Semi-DETR: Semi-Supervised Object Detection With Detection Transformers", CVPR, 2023 (*Baidu*). [[Paper](https://openaccess.thecvf.com/content/CVPR2023/html/Zhang_Semi-DETR_Semi-Supervised_Object_Detection_With_Detection_Transformers_CVPR_2023_paper.html)]
...
* General:
    ...
    * **SK-VG**: "Advancing Visual Grounding with Scene Knowledge: Benchmark and Method", CVPR, 2023 (*Sun Yat-sen University*). [[Paper](https://openaccess.thecvf.com/content/CVPR2023/html/Song_Advancing_Visual_Grounding_With_Scene_Knowledge_Benchmark_and_Method_CVPR_2023_paper.html)][[Code (in construction)](https://github.com/zhjohnchan/SK-VG)]
