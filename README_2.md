...
* Domain Adaptation/Domain Generalization/Federated Learning:
    ...
    * **RISE**: "A Sentence Speaks a Thousand Images: Domain Generalization through Distilling CLIP with Language Guidance", ICCV, 2023 (*UW-Madison*). [[Paper](https://arxiv.org/abs/2309.12530)][[Code (in construction)](https://github.com/OoDBag/RISE)]
...
* **CPLLM**: "CPLLM: Clinical Prediction with Large Language Models", arXiv, 2023 (*Ben Gurion University*). [[Paper](https://arxiv.org/abs/2309.11295)][[Code](https://github.com/nadavlab/CPLLM)]
