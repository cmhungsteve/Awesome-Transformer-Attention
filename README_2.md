...
* **?**: "Pose Priors from Language Models", arXiv, 2024 (*Berkeley*). [[Paper](https://arxiv.org/abs/2405.03689)]
...
* Facial Landmark:
    ...
    * **RHT**: "Precise Facial Landmark Detection by Reference Heatmap Transformer", IEEE, 2023 (*SUTD*). [[Paper](https://arxiv.org/abs/2303.07840)]
    * **STAR**: "STAR Loss: Reducing Semantic Ambiguity in Facial Landmark Detection", CVPR, 2023 (*Tencent*). [[Paper](https://arxiv.org/abs/2306.02763)][[Github](https://github.com/ZhenglinZhou/STAR)]
...
* Domain Adaptation/Domain Generalization/Federated Learning:
    ...
    * **ERM-ViT**: "Self-Distilled Vision Transformer for Domain Generalization", ACCV, 2022 (*MBZUAI*). [[Paper](https://arxiv.org/abs/2207.12392)][[PyTorch](https://github.com/maryam089/SDViT)]
    ...
    * **TransDA**: "Smoothing Matters: Momentum Transformer for Domain Adaptive Semantic Segmentation", arXiv, 2022 (*Tsinghua*). [[Paper](https://arxiv.org/abs/2203.07988)][[PyTorch)](https://github.com/alpc91/TransDA)]
    ...
    * **TVT**: "TVT: Transferable Vision Transformer for Unsupervised Domain Adaptation", WACV, 2023 (*UT Arlington + Kuaishou*). [[Paper](https://arxiv.org/abs/2108.05988)][[PyTorch](https://github.com/uta-smile/TVT)]
    ...
    * **MPA**: "Multi-Prompt Alignment for Multi-source Unsupervised Domain Adaptation", NeurIPS, 2023 (*Fudan University*). [[Paper](https://arxiv.org/abs/2209.15210)]
    ...
    * **StyLIP**: "StyLIP: Multi-Scale Style-Conditioned Prompt Learning for CLIP-based Domain Generalization", WACV, 2024 (*TUM*). [[Paper](https://arxiv.org/abs/2302.09251)]
    * **ReCLIP**: "ReCLIP: Refine Contrastive Language Image Pre-Training with Source Free Domain Adaptation", WACV, 2024 (*Amazon*). [[Paper](https://arxiv.org/abs/2308.03793)][[PyTorch](https://github.com/michiganleon/ReCLIP_WACV)]
    ...
    * **FedAPT**: "Cross-domain Federated Adaptive Prompt Tuning for CLIP", AAAI, 2024 (*Fudan University*). [[Paper](https://arxiv.org/abs/2211.07864)][[PyTorch](https://github.com/leondada/FedAPT)]
    * **VDPG**: "Adapting to Distribution Shift by Visual Domain Prompt Generation", ICLR, 2024 (*University of Toronto*). [[Paper](https://arxiv.org/abs/2405.02797)][[PyTorch](https://github.com/Guliisgreat/VDPG)][[Website](https://chi-chi-zx.github.io/VDPG_ICLR24/)]
...
* General:
    ...
    * **DA-CLIP**: "Controlling Vision-Language Models for Universal Image Restoration", ICLR, 2024 (*Uppsala University, Sweden*). [[Paper](https://arxiv.org/abs/2310.01018)][[PyTorch](https://github.com/Algolzw/daclip-uir)][[Website](https://algolzw.github.io/daclip-uir/index.html)]
...
* Denoise:
    ...
    * **CLIPDenoising**: "Transfer CLIP for Generalizable Image Denoising", CVPR, 2024 (*Huazhong University of Science and Technology (HUST)*). [[Paper](https://arxiv.org/abs/2403.15132)]
* Others:
...
* Feature Matching:
    ...
    * **OmniGlue**: "OmniGlue: Generalizable Feature Matching with Foundation Model Guidance", CVPR, 2024 (*Google*). [[Paper](https://arxiv.org/abs/2405.12979)][[Tensorflow](https://github.com/google-research/omniglue)][[Website](https://hwjiang1510.github.io/OmniGlue/)]
* Fine-grained:
...
* Place Recognition:
    ...
    * **BoQ**: "BoQ: A Place is Worth a Bag of Learnable Queries", CVPR, 2024 (*Universite Laval, Canada*). [[Paper](https://arxiv.org/abs/2405.07364)][[Code (in construction)](https://github.com/amaralibey/Bag-of-Queries)]
* Remote Sensing/Hyperspectral/Satellite:
    ...
    * **MMEarth**: "MMEarth: Exploring Multi-Modal Pretext Tasks For Geospatial Representation Learning", arXiv, 2024 (*University of Copenhagen, Denmark*). [[Paper](https://arxiv.org/abs/2405.02771)][[PyTorch](https://github.com/vishalned/MMEarth-train)][[Dataset](https://github.com/vishalned/MMEarth-data)][[Website](https://vishalned.github.io/mmearth/)]
* Robotics:
...
* Traffic (LLM-based):
    ...
    * **DriveSim**: "Probing Multimodal LLMs as World Models for Driving", arXiv, 2024 (*MIT*). [[Paper](https://arxiv.org/abs/2405.05956)][[Code (in construction)](https://github.com/sreeramsa/DriveSim)]
...
* 3D Motion Synthesis:
    ...
    * **?**: "Generating Human Motion in 3D Scenes from Text Descriptions", CVPR, 2024 (*Zhejiang*). [[Paper](https://arxiv.org/abs/2405.07784)][[Website](https://zju3dv.github.io/text_scene_motion/)]
...
* **RoFormer**: "RoFormer: Enhanced Transformer with Rotary Position Embedding", arXiv, 2021 (*Zhuiyi Technology*). [[Paper](https://arxiv.org/abs/2104.09864)][[Github](https://github.com/ZhuiyiTechnology/roformer)]
...
* **ALiBi**: "Train Short, Test Long: Attention with Linear Biases Enables Input Length Extrapolation", ICLR, 2022 (*Meta*). [[Paper](https://arxiv.org/abs/2108.12409)][[Github](https://github.com/ofirpress/attention_with_linear_biases)]
...
* **GQA**: "GQA: Training Generalized Multi-Query Transformer Models from Multi-Head Checkpoints", arXiv, 2023 (*Google*). [[Paper](https://arxiv.org/abs/2305.13245v2)]
